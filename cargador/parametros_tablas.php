...
$tablas_iniciales = array(
    ...
    'oferta' => 'periodo VARCHAR(7), sede VARCHAR(200), facultad VARCHAR(100), id_depto VARCHAR(10), codigo_asignatura VARCHAR(10), nombre_asignatura VARCHAR(200), seccion VARCHAR(4), duracion VARCHAR(20), vacantes VARCHAR(10), inscritos VARCHAR(10), dia VARCHAR(10), hora_inicio VARCHAR(10), hora_fin VARCHAR(10), fecha_inicio VARCHAR(10), fecha_fin VARCHAR(10), edificio VARCHAR(100), profesor_run VARCHAR(8), profesor_nombre VARCHAR(100), profesor_apellido VARCHAR(50), jerarquizacion VARCHAR(50)',
    'personas' => 'run VARCHAR(8) NOT NULL PRIMARY KEY, nombre VARCHAR(50), apellido VARCHAR(50), email VARCHAR(50), telefono VARCHAR(9), estamento VARCHAR(50)',
