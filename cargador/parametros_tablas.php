...
$tablas_iniciales = array(
    ...
    'estudiantes' => 'codigo_plan VARCHAR(3), carrera VARCHAR(20), cohorte VARCHAR(7), num_alumno VARCHAR(15), bloqueo CHAR, causal_bloqueo VARCHAR(50), run VARCHAR(8) PRIMARY KEY, dv CHAR, nombre_1 VARCHAR(50), nombre_2 VARCHAR(50), apellido_1 VARCHAR(50), apellido_2 VARCHAR(50), logro VARCHAR(50), fecha_logro VARCHAR(7), ultima_carga VARCHAR(7)',
