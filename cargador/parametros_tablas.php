...
$tablas_iniciales = array(
    'asignaturas' => 'plan VARCHAR(10), asignatura_id VARCHAR(6) PRIMARY KEY, asignatura VARCHAR(50), nivel INT, prerequisitos VARCHAR', 
    'estudiantes' => 'codigo_plan VARCHAR(3), carrera VARCHAR(20), cohorte VARCHAR(7), num_alumno VARCHAR(15), bloqueo CHAR, causal_bloqueo VARCHAR(50), run VARCHAR(10) PRIMARY KEY, dv CHAR, nombre_1 VARCHAR(50), nombre_2 VARCHAR(50), apellido_1 VARCHAR(50), apellido_2 VARCHAR(50), logro VARCHAR(50), fecha_logro VARCHAR(7), ultima_carga VARCHAR(7)',
    'historial' => 'run INT NOT NULL, codigo_plan VARCHAR(3), num_alumno VARCHAR(10), periodo VARCHAR(7), codigo_asignatura VARCHAR(10), convocatoria VARCHAR(3), calificacion VARCHAR(2), nota DECIMAL(4,2), PRIMARY KEY (run, codigo_asignatura, periodo)',
    ...
    'prerequisitos' => 'codigo_plan VARCHAR(3), asignatura_id VARCHAR(10) PRIMARY KEY, asignatura VARCHAR (20), nivel INT, prerequisito_1 VARCHAR(10), prerequisito_2 VARCHAR(10)',
    ...
    'oferta' => 'periodo VARCHAR(7), sede VARCHAR(20), facultad VARCHAR(20), id_depto INT, asignatura_id VARCHAR(10), seccion INT, duracion CHAR, vacantes INT, inscritos INT, dia VARCHAR(10), hora_inicio VARCHAR(10), hora_fin VARCHAR(10), fecha_inicio VARCHAR(10), fecha_fin VARCHAR(10), edificio VARCHAR(20), profesor_run INT, profesor_nombre VARCHAR(50), profesor_apellido VARCHAR(50), jerarquizacion VARCHAR(10)',
