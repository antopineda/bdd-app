...
$tablas_iniciales = array(
    ...
    //'planeacion' => 'periodo VARCHAR(7), sede VARCHAR(200), facultad VARCHAR(100), id_depto VARCHAR(10), departamento VARCHAR(50), codigo_asignatura VARCHAR(10), nombre_asignatura VARCHAR(200), seccion VARCHAR(4), duracion VARCHAR(20), vacantes VARCHAR(10), inscritos VARCHAR(10), dia VARCHAR(10), hora_inicio VARCHAR(10), hora_fin VARCHAR(10), fecha_inicio VARCHAR(10), fecha_fin VARCHAR(10),lugar VARCHAR(50), edificio VARCHAR(100), profesor_principal VARCHAR(50), profesor_run VARCHAR(9), PRIMARY KEY (periodo, codigo_asignatura, seccion)',
