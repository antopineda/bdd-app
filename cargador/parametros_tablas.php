...
$path_tablas = array(
    ...
    'adivinacion' => '../data/adivinacion.csv',
);
...
$tablas_iniciales = array(
    //'asignaturas' => 'codigo_plan VARCHAR(20), asignatura_id VARCHAR(20) PRIMARY KEY, asignatura VARCHAR(100), nivel VARCHAR(10)', 
    ...
    //'historial' => 'run VARCHAR(8) NOT NULL, codigo_plan VARCHAR(4), num_alumno VARCHAR(15), periodo VARCHAR(7), codigo_asignatura VARCHAR(20), convocatoria VARCHAR(10), calificacion VARCHAR(10), nota DECIMAL(4,2), PRIMARY KEY (run, codigo_asignatura, periodo, convocatoria)',
    ...
    //'prerequisitos' => 'codigo_plan VARCHAR(4), asignatura_id VARCHAR(20) PRIMARY KEY, asignatura VARCHAR (200), nivel VARCHAR(10), prerequisito_1 VARCHAR(20), prerequisito_2 VARCHAR(20)',
    ...
    'planeacion' => 'periodo VARCHAR(7), sede VARCHAR(200), facultad VARCHAR(100), id_depto INT, departamento VARCHAR(50), codigo_asignatura VARCHAR(10), nombre_asignatura VARCHAR(200), seccion INT, duracion VARCHAR(20), vacantes INT, inscritos INT, dia VARCHAR(10), hora_inicio VARCHAR(10), hora_fin VARCHAR(10), fecha_inicio VARCHAR(10), fecha_fin VARCHAR(10),lugar VARCHAR(50), edificio VARCHAR(100), profesor_principal VARCHAR(50), profesor_run VARCHAR(9), PRIMARY KEY (periodo, codigo_asignatura, seccion)',
    //'personas' => 'run VARCHAR(9) NOT NULL PRIMARY KEY, nombre VARCHAR(50), apellido VARCHAR(50), email VARCHAR(50), telefono VARCHAR(9), estamento VARCHAR(50)',
    // 'acta' => 'numero_alumno VARCHAR(50), run VARCHAR(40), curso VARCHAR(50), periodo VARCHAR(10), seccion VARCHAR(100), nota_final VARCHAR(50)'
    //'usuarios' => 'email VARCHAR(200) PRIMARY KEY, password VARCHAR(255), role VARCHAR(30)'

);

// Tablas que estan tal cual: asignaturas, estudiantes, planes, prerequisitos
// Si están comentadas es porque ya están cargadas en la BDD
