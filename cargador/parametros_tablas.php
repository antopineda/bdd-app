...
$tablas_iniciales = array(
    'asignaturas' => 'plan VARCHAR(20), asignatura_id VARCHAR(20) PRIMARY KEY, asignatura VARCHAR(100), nivel VARCHAR(10), prerequisitos VARCHAR(20)', 
