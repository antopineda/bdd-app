...
$tablas_iniciales = array(
    ...
    'estudiantes' => 'codigo_plan VARCHAR(3), carrera VARCHAR(20), cohorte VARCHAR(7), num_alumno VARCHAR(15), bloqueo CHAR, causal_bloqueo VARCHAR(50), run VARCHAR(10) PRIMARY KEY, dv CHAR, nombre_1 VARCHAR(50), nombre_2 VARCHAR(50), apellido_1 VARCHAR(50), apellido_2 VARCHAR(50), plan VARCHAR(10), logro VARCHAR(50), fecha_logro VARCHAR(7), ultima_carga VARCHAR(7)',
    'historial' => 'run INT NOT NULL PRIMARY KEY, codigo_plan VARCHAR(3), num_alumno VARCHAR(10), periodo VARCHAR(7), codigo_asignatura VARCHAR(10), convocatoria VARCHAR(3), calificacion VARCHAR(2), nota DECIMAL(4,2)',
