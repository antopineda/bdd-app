...
$tablas_iniciales = array(
    ...
    'estudiantes' => 'codigo_plan VARCHAR(3), carrera VARCHAR(20), cohorte VARCHAR(7), bloqueo CHAR, causal_bloqueo VARCHAR(50), RUN VARCHAR(10) PRIMARY KEY, nombre VARCHAR(50), apellido VARCHAR(50), plan VARCHAR(10), logro VARCHAR(50), fecha_logro VARCHAR(7), ultima_carga VARCHAR(7)',
    'historial_académico' => 'RUN INT NOT NULL, num_alumno VARCHAR(10), periodo VARCHAR(7), codigo VARCHAR(10), convocatoria VARCHAR(3), calificacion VARCHAR(2), nota DECIMAL(4,2)',
